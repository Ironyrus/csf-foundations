...
public class day26RestController {
    ...
    // http://localhost:8080
    @GetMapping(path="/")
    public ResponseEntity<String> getHomeForAngular(@RequestParam("name") String name, @RequestParam("last_name") String last_name) {
        
        // Getting full list of games
        List<Document> games = repo.getGames(1000, 0);
